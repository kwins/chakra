...
./build/chakra-cli --command=set --ip=10.210.16.240 --port=7290  --set_keys=db1:my_key_1 --set_values=value_1 --push_ttl=2000
./build/chakra-cli --command=push --ip=10.210.16.240 --port=7290  --push_key=db1:my_key_1 --push_values=aaa,bbb,ccc --push_ttl=2000
