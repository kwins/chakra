...
DEFINE_double(replica_cron_interval_sec, 0.3, "replica cron interval sec, use double");                                 /* NOLINT */
DEFINE_int32(replica_timeout_retry, 10, "replica timeout retry");                                                       /* NOLINT */
DEFINE_double(replica_delta_pull_interval_sec, 0.3, "replica pull db dalta interval sec");                              /* NOLINT */
...
DEFINE_double(replica_bulk_send_interval_sec, 0.3, "replica send db bulk interval sec");                                /* NOLINT */
...
DEFINE_int32(db_cache_shard_size, sysconf(_SC_NPROCESSORS_CONF), "rocksdb cached shard size");                     /* NOLINT */
